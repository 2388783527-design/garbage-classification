...
# 两个 WCF 模型路径
MODEL_PATHS = {
    'WCF 直接训练': r'D:\suju\runs\detect\YOLO26s_weighted2\weights\best.pt',
    'WCF 分阶段训练': r'D:\suju\runs\detect\YOLO26s_weighted_final\weights\best.pt',
}
...
CONF_THRESHOLD = 0.5
OUTPUT_IMG = r'D:\suju\wcf_training_strategy_comparison.png'
# ================================================
...
# ================== 配置区域 ==================
# 请根据实际路径确认以下两个模型文件的位置
MODEL_PATHS = {
    'YOLO26s (基线)': r'D:\suju\runs\detect\YOLO26s(1)2\weights\best.pt',
    'YOLO26s + WCF (本文)': r'D:\suju\runs\detect\YOLO26s_weighted_final\weights\best.pt',
}
...
DATA_YAML = r'D:\suju\yolov8_garbage_new\garbage.yaml'
CONF_THRESHOLD = 0.5
OUTPUT_IMG = r'D:\suju\yolo26s_vs_wcf_comparison.png'
# ================================================
